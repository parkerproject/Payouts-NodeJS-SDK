...
module.exports = {
  ...
  LiveEnvironmentWithAccessToken: require('./paypal_environment').LiveEnvironmentWithAccessToken,
  SandboxEnvironmentWithAccessToken: require('./paypal_environment').SandboxEnvironmentWithAccessToken,
